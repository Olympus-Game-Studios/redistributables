(function() {
    ...
    function redirectToDashboard(userData, usernameForBootstrap, passwordForBootstrap, accessToken) {
        ...
        try {
            ...
            // Keep only the last 3 login activities (but keep other activity types)
            const pruned = [];
            let loginCount = 0;
            ...
            if (pruned.length > 20) pruned.length = 20;
            localStorage.setItem('atlas_activities', JSON.stringify(pruned));
        } catch (e) {
